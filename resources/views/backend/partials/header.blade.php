    ...
    <div class="flex flex-col h-full">
        ...
        <nav class="flex-1 overflow-y-auto">
            <ul class="px-4 py-2 space-y-1">
                <li><a href="{{ route('dashboard') }}" class="text-gray-800 py-3 block hover:text-red-600 font-medium text-sm border-b">DASHBOARD</a></li>
                <li><a href="{{ route('admin.news.index') }}" class="text-gray-800 py-3 block hover:text-red-600 font-medium text-sm border-b">NEWS MANAGEMENT</a></li>
                <li><a href="{{ route('admin.categories.index') }}" class="text-gray-800 py-3 block hover:text-red-600 font-medium text-sm border-b">CATEGORIES</a></li>
                <li><a href="{{ route('admin.videos.index') }}" class="text-gray-800 py-3 block hover:text-red-600 font-medium text-sm border-b">VIDEOS</a></li>
                <li><a href="/" target="_blank" class="text-gray-800 py-3 block hover:text-red-600 font-medium text-sm border-b">VIEW SITE</a></li>
            </ul>
        </nav>
    </div>
</div>
    ...
    <nav class="bg-red-700 border-t border-red-800 hidden md:block">
        <div class="container mx-auto">
            <ul class="flex justify-center space-x-8 lg:space-x-12">
                <li><a href="{{ route('dashboard') }}" class="text-white py-3 inline-block hover:text-yellow-500 font-medium text-sm tracking-wide">DASHBOARD</a></li>
                <li><a href="{{ route('admin.news.index') }}" class="text-white py-3 inline-block hover:text-yellow-500 font-medium text-sm tracking-wide">NEWS MANAGEMENT</a></li>
                <li><a href="{{ route('admin.categories.index') }}" class="text-white py-3 inline-block hover:text-yellow-500 font-medium text-sm tracking-wide">CATEGORIES</a></li>
                <li><a href="{{ route('admin.videos.index') }}" class="text-white py-3 inline-block hover:text-yellow-500 font-medium text-sm tracking-wide">VIDEOS</a></li>
                <li><a href="/" target="_blank" class="text-white py-3 inline-block hover:text-yellow-500 font-medium text-sm tracking-wide">VIEW SITE</a></li>
            </ul>
        </div>
    </nav>
</header>
